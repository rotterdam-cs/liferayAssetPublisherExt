...
<%
final class CustomAssetEntryQuery extends AssetEntryQuery{

	public CustomAssetEntryQuery() {
		super();
	}
	...
	public boolean isCustomQuery() {
		return ((customFieldOrder!=null) && (!customFieldOrder.isEmpty()));
	}
}
...
CustomAssetEntryQuery assetEntryQuery = new CustomAssetEntryQuery();

String[] allAssetTagNames = new String[0];

if (selectionStyle.equals("dynamic")) {
	if (!ArrayUtil.contains(groupIds, scopeGroupId)) {
		AssetEntryQuery aeq = AssetPublisherUtil.getAssetEntryQuery(preferences, ArrayUtil.append(groupIds, scopeGroupId));
		assetEntryQuery = new CustomAssetEntryQuery(aeq);
	}
	else {
		AssetEntryQuery aeq = AssetPublisherUtil.getAssetEntryQuery(preferences, groupIds);
		assetEntryQuery = new CustomAssetEntryQuery(aeq);
	}
...

String customOrder = GetterUtil.getString(preferences.getValue("customOrder", ""));
String customOrderByType = GetterUtil.getString(preferences.getValue("customOrderByType", ""));
String customFieldType = GetterUtil.getString(preferences.getValue("customFieldType", ""));
String customFilterFieldName1 = GetterUtil.getString(preferences.getValue("customFilterFieldName1", ""));
String customFilterComparator1 = GetterUtil.getString(preferences.getValue("customFilterComparator1", ""));
String customFilterValue1 = GetterUtil.getString(preferences.getValue("customFilterValue1", ""));
String customFilterFieldType1 = GetterUtil.getString(preferences.getValue("customFilterFieldType1", ""));
String customFilterFieldName2 = GetterUtil.getString(preferences.getValue("customFilterFieldName2", ""));
String customFilterComparator2 = GetterUtil.getString(preferences.getValue("customFilterComparator2", ""));
String customFilterValue2 = GetterUtil.getString(preferences.getValue("customFilterValue2", ""));
String customFilterFieldType2 = GetterUtil.getString(preferences.getValue("customFilterFieldType2", ""));

